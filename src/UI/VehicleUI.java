...
public class VehicleUI extends JFrame {
    ...
    public VehicleUI() {
        setTitle("Car Rental System - Vehicle");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new DefaultTableModel(
                ...
                new String[]{
                        "Id", "Name", "Color", "Price / Day (in rs)", "Owner", "Status"
                }
        ) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {
        setVisible(false);
        new AddVehicle(null, null, null, null, null);
    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (selectedRow != -1) {
            ...
            String color = (String) table.getValueAt(selectedRow, 2);
            String pricePerDay = (String) table.getValueAt(selectedRow, 3);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (selectedRow != -1) {
            String id = (String) table.getValueAt(selectedRow, 0);
            if (vehicleController.delete(Integer.parseInt(id))) {
                DefaultTableModel dtm = (DefaultTableModel) table.getModel();
                dtm.setRowCount(0);
                Object[][] data = vehicleService.getAll();
                for (Object[] row : data) {
                    dtm.addRow(row);
                }
            } else {
